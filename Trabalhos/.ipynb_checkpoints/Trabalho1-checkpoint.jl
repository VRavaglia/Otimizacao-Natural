...
# ╔═╡ cc80f690-d152-11ec-29f9-dd224e08a3f4
begin
	using Random
	using LinearAlgebra
	using Plots
...
# ╔═╡ d62b6350-c96e-4f0b-be82-9eac22024b18
html"""
<style>
    main {
        margin: 0 auto;
...
# ╔═╡ 21f5a999-5fc5-403c-b715-0b7aca84bc72
begin
...
# ╔═╡ e444e95d-53ad-44ef-aa59-a37731f5b562
function J(ordem)
    distTot = 0.0
    for i = 2:cidades
...
# ╔═╡ b7bcad4c-9261-4e7b-a1e5-08ae664e9635
Jotimo = J(ordemOtima)

# ╔═╡ 0d2dde41-9190-430b-a634-0a63879dd2a8
# Simulated Annealing
...
# ╔═╡ 207d47c5-1d09-465a-ab3d-f0707c115250


# ╔═╡ 67fe9d82-8a5f-4177-9b3d-6f8173ec9965
begin
	bestCFG = 0
	bestJ = 1e4
	allOrdemMin = []
	...
	for seed = seeds
		push!(daggers, Dagger.@spawn ordemMin, distancias, temperaturas, Jmin, k, minIts = SA(seed, T0, N, Kmax));
	end
...
# ╔═╡ 89492123-1b33-4b54-890a-4a13e1966f1a
begin
	...
	quiver!(x[bOrdem, 1],x[bOrdem, 2],quiver=(x[[bOrdem[2:end]; 1], 1] - x[bOrdem, 1],x[[bOrdem[2:end]; 1], 2] - x[bOrdem, 2])) 
	# quiver!(x[ordemOtima, 1],x[ordemOtima, 2],quiver=(x[[ordemOtima[2:end]; 1], 1] - x[ordemOtima, 1],x[[ordemOtima[2:end]; 1], 2] - x[ordemOtima, 2])) 
	
	
end

# ╔═╡ dbebc9d2-ffc2-4880-9ba5-b0f8613dec38
bOrdem

# ╔═╡ 44b33754-ccf7-4d9f-b8ee-65ecb22af18f
begin
	step = 100
...
# ╔═╡ a168bd8e-7725-4476-bae7-581af46b486c
begin
	otimo = false
	if (Jmin - Jotimo) < 0.001
	    otimo = true
	...
	resultados = string(cidades, ",", T0 ,"," , N , "," , Kmax , "," , bestJ , "," , tempoFinal, ",", HMenorJ, "," , seedFinal , ",", otimo, "\n")
	println(resultados)
